<div class="container">
    ...
    <!-- Button trigger modal - hanya untuk admin dan danny -->
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="judul" placeholder="Masukan username"
                                required>
                        </div>
                        <div class="mb-3">
...
<?php
// Pengecekan otorisasi - hanya admin dan danny yang bisa akses
if (!isset($_SESSION['username']) || ($_SESSION['username'] != 'admin' && $_SESSION['username'] != 'danny')) {
    echo "
    <script>
        alert('Akses ditolak! Hanya admin dan danny yang dapat mengelola user.');
    ...
    echo "
    <script> 
        alert('Akses diterima: Selamat datang, " . $_SESSION['username'] . "!');
    </script>
    ";
}
...
if (isset($_POST['simpan'])) {
    $username = $_POST['judul']; // Mengambil dari form input name="judul"
    ...
    if (!empty($password_input)) {
        ...
        $password = ''; // Akan ditangani berbeda untuk update
    }
