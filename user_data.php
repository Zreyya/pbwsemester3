...
include "koneksi.php";
        ...
        <tr>
            ...
            <td>
                <?php if ($_SESSION['username'] == 'admin' || $_SESSION['username'] == 'danny'): ?>
                ...
                <?php else: ?>
                <span class="badge rounded-pill text-bg-secondary">No Access</span>
                <?php endif; ?>
                        ...
                        <div class="modal-content">
                            ...
                            <form method="post" action="" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="formGroupExampleInput3" class="form-label">foto
                                            Lama</label>
                                        <?php
                                                if ($row["foto"] != '') {
                                                    if (file_exists('img/' . $row["foto"] . '')) {
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="formGroupExampleInput" class="form-label">Yakin akan
                                            menghapus user
                                            "<strong><?= $row["username"] ?></strong>"?</label>
                                        <input type="hidden" name="id" value="<?= $row["id"] ?>">
